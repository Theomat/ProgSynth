...
__forbidden_patterns = {
    ...
    "TAIL": ["REVERSE", "SCAN1L[+]", "SCAN1L[max]", "SCAN1L[min]", "SORT"],
    "MINIMUM": ["REVERSE", "SCAN1L[max]", "SCAN1L[min]", "SORT"],
    "MAXIMUM": ["REVERSE", "SCAN1L[max]", "SCAN1L[min]", "SORT"],
    "LENGTH": [
        "FILTER[<0]",
        "FILTER[>0]",
        "FILTER[EVEN]",
    ...
    "SUM": ["REVERSE", "SORT"],
    "SORT": ["REVERSE", "SCAN1L[max]", "SORT"],
    "REVERSE": ["REVERSE"],
    "FILTER[<0]": ["FILTER[<0]", "FILTER[>0]", "MAP[**2]"],
    "FILTER[>0]": ["FILTER[<0]", "FILTER[>0]"],
    "FILTER[EVEN]": ["FILTER[EVEN]", "FILTER[ODD]", "MAP[*2]", "MAP[*4]"],
    "FILTER[ODD]": ["FILTER[EVEN]", "FILTER[ODD]", "MAP[*2]", "MAP[*4]"],
    "MAP[+1]": ["MAP[-1]"],
    "MAP[-1]": ["MAP[+1]"],
    "MAP[*2]": ["MAP[*2]"],
    "MAP[/2]": ["MAP[*2]", "MAP[*4]", "MAP[/2]"],
    "MAP[*-1]": ["MAP[*-1]"],
    "MAP[**2]": ["MAP[*-1]"],
    "MAP[/3]": ["MAP[*3]"],
    "MAP[/4]": ["MAP[*2]", "MAP[*4]"],
    "SCAN1L[min]": ["SCAN1L[min]"],
    "SCAN1L[max]": ["SCAN1L[max]", "SORT"],
}
